...
//		val factoryConfig = SessionContainerConfig("defaultName", List(
...
//		val conf1 = Configuration.read("example/session.conf", classOf[SessionContainerConfig], ConfigurationFormat.JSON)
//		
